...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${ovo.variable} ${red_hat_text.variable} ${red_hat_display.variable} ${fira_code.variable}`}>
          ...
          <main className="flex min-h-screen flex-col items-center bg-dark-green text-lighter-green font-body">
            <div className="flex w-full justify-between">
              ...
              <div className="flex justify-center">
                ...
                <div className="text-lg p-5"><a href="/dot">Viewer</a></div>
                <div className="text-lg p-5"><a href="/dp">Playground</a></div>
