...
println!("relation = {relation}");`}</Rust>
      ...
      <div className="w-full max-w-7xl flex flex-col items-left bg-dark text-lighter-green py-10 z-10">
        <div className="font-display text-sm py-1 text-[#999999]">Licensed under the Apache License, Version 2.0 (the &quot;License&quot;);
          you may not use this file except in compliance with the License.
          You may obtain a copy of the License at
        </div>
        <div className="font-display text-sm py-1 text-[#999999]">
          <a href="http://www.apache.org/licenses/LICENSE-2.0">http://www.apache.org/licenses/LICENSE-2.0</a>
        </div>
        <div className="font-display text-sm py-1 text-[#999999]">Unless required by applicable law or agreed to in writing, software
